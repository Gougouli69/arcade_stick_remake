...
export class JoyStick {
  ...
  registerEvents() {
    ...
    if ("ontouchstart" in document.documentElement) {
      this.canvas.addEventListener( // APPUIE DOIGT SUR ECRAN TACTILE, UN OU PLUSIEURS CONTACT
        "touchstart",
        (ev) => {
      ...
      this.canvas.addEventListener( // DEPLACEMENT SUR ECRAN TACTILE, UN OU PLUSIEURS CONTACT
        "touchmove",
        (ev) => {
          this.onTouchMove(ev);
        },
      ...
      this.canvas.addEventListener( // RETIRER DOIGT SUR ECRAN TACTILE, UN OU PLUSIEURS CONTACT
        "touchend",
        (ev) => {
          this.onTouchEnd(ev);
        },
